...
//		        		"下一步，该航空母舰将按计划进行系统设备调试和舾装施工，并全面开展系泊试验。";
		        ...
		        List<String> natures = AHANLP.getNatureList(stdSegResult);
		        for (Term term : stdSegResult) {
					System.out.println(term.word+":"+GlobalConstants.partOfSpeech.get(term.nature.name()));
				}
